    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {cars && cars.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cars.map((car) => {
            // Find active booking (if any) for this car to show reclaim and countdown
            const activeBooking =
              car.bookings?.find(
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  ...
                  {/* View History button – we need the user ID from active booking or fallback */}
                  <Button
                    variant="secondary"
                    size="sm"
                    onClick={() => {
                      // If we have a booking, we can show history for the user who rented it.
                      // If not, we can allow selecting a user later.
                      const userId =
                        activeBooking?.user || car.user?._id || null;
                      if (userId) {
